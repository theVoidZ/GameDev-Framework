...
class KernelRules {
    public:
        ...
        ///
        void create_rule(boost::typeindex::type_index dependent, boost::typeindex::type_index depended );
        //////////////////////////////////////////////////////////////////////////////////////////////////////////

        //////////////////////////////////////////////////////////////////////////////////////////////////////////
        void create_host_limitation_rule(boost::typeindex::type_index dependent, boost::typeindex::type_index host );

        //////////////////////////////////////////////////////////////////////////////////////////////////////////

        //////////////////////////////////////////////////////////////////////////////////////////////////////////
        /// \brief Create a multiplicity rule, by setting the class \a target to have max instance
        ///
        void set_type_cardinality( boost::typeindex::type_index t, unsigned char max );
        //////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public:
        //////////////////////////////////////////////////////////////////////////////////////////////////////////
        template< typename T >
        static boost::typeindex::type_index type_id_with_cvr(){
    ...
    public:
        ...
        ///
        std::map< boost::typeindex::type_index, std::list< boost::typeindex::type_index > > hostobject_limitation_rules;
        //////////////////////////////////////////////////////////////////////////////////////////////////////////

        //////////////////////////////////////////////////////////////////////////////////////////////////////////
        /// \brief List of dependecies rules
        ///
        std::map<boost::typeindex::type_index, std::list< boost::typeindex::type_index > > components_dependency_rules;
        //////////////////////////////////////////////////////////////////////////////////////////////////////////

        //////////////////////////////////////////////////////////////////////////////////////////////////////////
        /// \brief List of the classes set as singleton
        /// Can perform checking on 255 or less.
        std::map< boost::typeindex::type_index, unsigned char > components_cardinality_rules;
        //////////////////////////////////////////////////////////////////////////////////////////////////////////
