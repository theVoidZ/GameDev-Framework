...
/// Defines a viewport onto the screen.
struct Viewport{
    Viewport(sf::FloatRect r);

    /// Determines if a viewport is binded to a scene/camera or not.
    /// \return true if this viewport is attached to a scene and a camera, otherwise returns false.
    bool is_assigned() const;

    //////////////////////////////////////////////////////////////////////////////////////////////////////////
    /// \brief Get the Scene instance related to the Camera.
    ///
    Scene* get_camera_scene();

    /// \brief Defines absolute positionning on the screen ( GameInfo size )
    sf::FloatRect rect = sf::FloatRect();


    /// \brief Defines the Viewport (Camera) on the scene 'scene'
    tracker_ptr< Camera > camera; // REDUNDANT


    /// \brief Determines whether the viewport is enabled or not.
    bool enabled = false;
...
///
/// \bug It supports multi-scenes management. [But NOT fully functionning at the moment]
///
/// \todo int main(int** args)
///
/// You can override this class in order to implement your own GameLogic ( from scratch )
///
/// \note GameInfo inherits from \a ComponentContainer which provides it with a Component Container allowing it to host Components.
                    ...
                    public ComponentContainer
{
    ...
    public:
        ...
        /// NOTE: Template this method, in case deriving Scene is allowed
        ///
        int add_scene( std::string name, bool is_active = true );
        //////////////////////////////////////////////////////////////////////////////////////////////////////////

    public:
        //////////////////////////////////////////////////////////////////////////////////////////////////////////
        void add_viewport( sf::FloatRect r );
        //////////////////////////////////////////////////////////////////////////////////////////////////////////

        //////////////////////////////////////////////////////////////////////////////////////////////////////////
        void bind(int viewport_index, tracker_ptr<Camera> camera);
        //////////////////////////////////////////////////////////////////////////////////////////////////////////
         ...
         * UNBIND THE LINK
         *
         * @param viewport_index
         *
         */
        void unbind(int viewport_index);
        //////////////////////////////////////////////////////////////////////////////////////////////////////////

    // methods dedicated for LOGIC
    public:
        //////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    private:
        ...
        ///
        sf::Clock clock;
        sf::Time residu = sf::Time::Zero;
        //////////////////////////////////////////////////////////////////////////////////////////////////////////

    public:
        //////////////////////////////////////////////////////////////////////////////////////////////////////////
        /// \brief Repaint color of the screen ( Unified for all scenes !!)
        ///
        sf::Color clear_color = sf::Color::Black;
        //////////////////////////////////////////////////////////////////////////////////////////////////////////

        //////////////////////////////////////////////////////////////////////////////////////////////////////////
        /// \brief List of all the viewports of the GameInfo
        ///
        std::vector< Viewport* > viewports_;
        //////////////////////////////////////////////////////////////////////////////////////////////////////////

        //////////////////////////////////////////////////////////////////////////////////////////////////////////
        /// \brief Set of rules to use for this GameInfo
        KernelRules* kernel_ = nullptr;
        //////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        SceneLoaderBase* scene_loader = nullptr;
